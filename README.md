...
(experimental)
> wget https://github.com/slynobody/SteamOS-wallpaper-engine-kde-plugin/releases/download/0.9/int_wallpaper_engine_qt6-1-1a_amd64.deb
> 
> sudo apt install ./int_wallpaper_engine_qt6-1-1a_amd64.deb
...
plasma 6.7+
(highly experimental)
> sudo wget https://github.com/slynobody/SteamOS-wallpaper-engine-kde-plugin/releases/download/0.9/WallpaperEngine_kde6-1_1l-1-x86_64.pkg.tar.zst
> 
> sudo pacman -U ./WallpaperEngine_kde6-1_1l-1-x86_64.pkg.tar.zst --overwrite '*'
